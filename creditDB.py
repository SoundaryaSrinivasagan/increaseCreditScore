...
def creditDetails(creditCardDict, creditLineOfCreditDict, creditOtherDict):
	...
	while ('y' in val_creditCard):
		val_creditCard_name = input("What is the name of this credit card? [ n spaces ]  ")
	...
	while ('y' in val_lineOfCredit):
		val_creditCard_loc_name = input("Which bank do you have this line of credit with? [ n spaces ]  ")
	...
	while ('y' in val_otherCredit):
		val_creditCard_other_name = input("What is the name of this credit product? [ n spaces ]  ")
